                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <form action="{{ route('order.status', $order->id) }}" method="POST">
                                    @csrf
                                    <td>
                                        <input name="status" type="submit" value="aceito" class="btn btn-warning btn-small">
                                        <input name="status" type="submit" value="pendente" class="btn btn-info btn-small mt-2">
                                        
                                    </td>
                                    <td>
                                    <input name="status" type="submit" value="rejeitado" class="btn btn-danger btn-small">
                                    <input name="status" type="submit" value="concluído" class="btn btn-success btn-small mt-2">
                                    </td>
                                </form>
